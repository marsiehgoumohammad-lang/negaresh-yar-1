      ...
      <Container>
        ...
        <div id="what-is-absent-judgment" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          ...
          <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed text-justify">
            <p>
              در نظام دادرسی ایران، اصل بر برگزاری دادگاه با حضور دو طرف دعوا (خواهان و خوانده در دعاوی حقوقی؛ شاکی و متهم در دعاوی کیفری) و استماع اظهارات و دفاعیات طرفین است. با این وجود، چنانچه دادگاه جلسهای تشکیل دهد و یکی از طرفین (معمولاً خوانده یا متهم) در فرآیند دادرسی حاضر نباشد، رأیی که صادر میشود ممکن است <strong>«حکم غیابی» (Default / Absent Judgment)</strong> باشد.
            </p>
            <p>
              بر اساس <strong>ماده ۳۰۳ قانون آیین دادرسی مدنی</strong> و <strong>ماده ۴۰۶ قانون آیین دادرسی کیفری</strong>، یک حکم زمانی «غیابی» محسوب میشود که هر سه شرط زیر به طور همزمان محقق شده باشد:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
              ...
              <div className="p-4 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  خوانده، متهم، وکیل تعیینی یا نماینده قانونی وی در هیچیک از جلسات دادگاه حاضر نشده باشند.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  خوانده یا متهم هیچگونه لایحه، پاسخ کتبی یا دفاعیهای به دادگاه ارسال نکرده باشد.
                </p>
              </div>
            </div>

            <div className="p-4 rounded-xl bg-[#070B15] border border-amber-500/20 text-amber-200 text-xs sm:text-sm leading-relaxed">
              <strong>تفاوت کلیدی حکم حضوری و غیابی:</strong> اگر حتی یک برگ لایحه فرستاده باشید یا در یکی از جلسات حاضر شده باشید یا ابلاغ واقعی شده باشد، رأی دادگاه «حضوری» بوده و حق واخواهی از بین میرود و تنها راه اعتراض، تجدیدنظرخواهی خواهد بود.
            </div>
          </div>
        </div>
        ...
        <div id="when-is-objection-possible" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          ...
          <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed text-justify">
            <p>
              طبق <strong>ماده ۳۰۵ قانون آیین دادرسی مدنی</strong>، محکومعلیه غیابی حق دارد به حکمی که در غیاب او صادر شده اعتراض نماید. این حق قانونی «واخواهی» نام دارد و باعث میشود پرونده مجدداً در همان شعبه بدوی صادرکننده رأی با حضور خوانده به جریان بیفتد.
            </p>
            <p>
              امکان واخواهی در وضعیتهای حقوقی زیر وجود دارد:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  احکام مطالبه وجه چک، سفته، مطالبات قراردادی، خسارت تأخیر تأدیه، الزام به تنظیم سند رسمی، تخلیه ید و دعاوی مالی که خوانده در دادرسی بیاطلاع بوده است.
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  احکام غیابی مطالبه مهریه، نفقه معوقه، اجرتالمثل ایام زوجیت یا طلاق غیابی صادرشده از دادگاههای خانواده.
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  هنگامی که اجرائیه صادر شده و حسابهای بانکی مسدود یا دستور جلب صادر شده است، با ثبت واخواهی کلیه اقدامات اجرایی تا تصمیم بعدی معلق میشود.
                </p>
              </div>
            </div>
          </div>
        ...
        <div id="legal-deadline" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          ...
          <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed text-justify">
            <p>
              مهلتهای قانونی برای ثبت دادخواست واخواهی مطابق قانون آیین دادرسی مدنی و کیفری به شرح زیر است:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-[#070B15] border-r-4 border-[#E5C158] space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  از تاریخ «ابلاغ واقعی» دادنامه در سامانه ثنا (روزی که شخصاً ابلاغیه را باز کرده و مشاهده نمودهاید) یا از تاریخ اطلاع واقعی از صدور رأی غیابی.
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-[#070B15] border-r-4 border-sky-500 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  از تاریخ ابلاغ رسمی در سامانههای کنسولی/ثنا یا ابلاغ به وکیل و نماینده مقیم ایران.
                </p>
              </div>
            </div>
        ...
        <div id="steps-to-file" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl sm:text-2xl font-black text-white">
              ۴. مراحل گامبهگام ثبت دادخواست واخواهی و توقف اجرای حکم
            </h3>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#070B15] border border-slate-800">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  دانلود متن کامل دادنامه از کارتابل ابلاغ الکترونیک قضایی و بررسی تاریخ و نوع ابلاغها و ادعاهای مطرحشده توسط خواهان.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#070B15] border border-slate-800">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  پرونده به همان شعبه ارجاع میشود؛ قاضی دستور توقف فوری عملیات اجرایی و رفع انسداد حسابها را صادر کرده و جلسه دادرسی جدید با حضور طرفین برگزار میگردد.
                </p>
              </div>
            </div>
          </div>
        ...
        <div id="grounds-for-accepting" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl sm:text-2xl font-black text-white">
              ۵. مهمترین دلایل پذیرش واخواهی و نقض رأی غیابی در دادگاه
            </h3>
          </div>

          <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
            دادگاههای حقوقی و کیفری در صورت ارائه ادله زیر توسط واخواه (محکومعلیه غیابی)، رأی سابق را فسخ کرده و حکم به نفع وی صادر مینمایند:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                اثبات اینکه ابلاغها به آدرس اشتباه ارسال شده یا متهم/خوانده به دلیل عدم ثبت در ثنا یا مشکلات سامانهای اصلاً از تشکیل دادگاه باخبر نبوده است.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                ارائه اسناد پزشکی، مدارک مسافرت اضطراری یا گواهی مراجع ذیربط دال بر بروز بیماری یا حوادث قهری که مانع حضور فرد در دادگاه شده است.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                ارائه فیشهای واریزی، اسناد تسویه حساب، رسید امانی بودن وجوه، شهادت شهود یا درخواست ارجاع به کارشناسی رسمی که قبلاً در پرونده غایب بوده است.
              </p>
            </div>
        ...
        <div id="comparison-table" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            بررسی مرجع رسیدگی، زمان استفاده، مهلت و اثر حقوقی روشهای گوناگون اعتراض به آرای دادگاهها:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm text-slate-300">
            <div className="p-4 rounded-2xl bg-[#070B15] border border-red-500/20 space-y-2">
              ...
              <p className="text-slate-400 leading-relaxed">
                اگر حتی یک بار لایحه فرستاده باشید یا ابلاغ واقعی شده باشد، رأی حضوری است و دادخواست واخواهی فوراً رد میشود؛ در این حالت باید مستقیماً تجدیدنظرخواهی کنید.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#070B15] border border-amber-500/20 space-y-2">
              ...
              <p className="text-slate-400 leading-relaxed">
                تعلل در ثبت دادخواست پس از اطلاع از رأی در ثنا باعث انقضای مهلت و قطعی شدن رأی میگردد؛ مگر اینکه بتوانید عذر موجه قانونی را در دادگاه اثبات کنید.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#070B15] border border-blue-500/20 space-y-2">
              ...
              <p className="text-slate-400 leading-relaxed">
                دادخواست واخواهی باید حاوی دفاعیات دقیق ماهوی و دلایل جدید باشد؛ صرف ابراز بیاطلاعی بدون ارائه مدارک نقضکننده ادعای خواهان، نتیجهای نخواهد داشت.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#070B15] border border-purple-500/20 space-y-2">
              ...
              <p className="text-slate-400 leading-relaxed">
                اگر دیرتر از ۲۰ روز اقدام کردهاید، حتماً باید مدارک پزشکی، مأموریت یا ادله عدم ابلاغ واقعی را ضمیمه کنید تا دادگاه به واخواهی ورود پیدا کند.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-gradient-to-r from-[#0C1222] via-[#0F172A] to-[#0C1222] border border-[#E5C158]/30 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm text-slate-300">
            ...
            <div className="p-4 rounded-xl bg-[#070B15] border border-slate-800 space-y-1">
              ...
              <p className="text-slate-400">
                برای پروندههای پیچیده، دعاوی مالی سنگین یا مواردی که نیاز به حضور وکیل در جلسه دادرسی بدوی دارید، از بخش <Link href="/lawyer-referral" className="text-[#E5C158] underline font-bold">معرفی وکیل منصف</Link> اقدام کنید.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#111827] via-[#0D1424] to-[#111827] border-2 border-[#E5C158]/50 rounded-3xl p-6 sm:p-8 text-center space-y-4 shadow-xl shadow-[#E5C158]/10">
          ...
          <p className="text-slate-300 text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed">
            با تنظیم یک دادخواست واخواهی اصولی و مستند توسط کارشناسان ارشد نگارش یار، اجرای حکم و انسداد حسابها را فوراً متوقف کرده و پرونده را از نو با دفاع قوی پیگیری کنید.
          </p>
