      ...
      <Container>
        ...
        <div id="legal-basis" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          ...
          <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed text-justify">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
                <span className="text-xs font-bold text-[#E5C158] block">ماده ۱۳۶ ق.ا.ا.م (موارد قطعی بطلان مزایده)</span>
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  فروش در غیر روز و ساعت و محلی که در آگهی معین شده، بدون حضور نماینده دادسرا، عدم رعایت مهلت نشر آگهی، خرید توسط افراد ممنوع (قضات، دادورزان و بستگان درجه یک تا سه)، و فروش با بهای کمتر از قیمت کارشناسی در نوبت اول.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  شکایت از نحوه ارزیابی یا اقدامات خلاف مقررات دادورز باید ظرف یک هفته از تاریخ فروش تقدیم دادگاه شود. دادگاه پیش از صدور دستور انتقال رسمی سند، مکلف به بررسی صحت کل فرآیند است.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-r from-[#172033] to-[#0D1424] border-2 border-[#E5C158]/50 text-slate-200 space-y-3">
              ...
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed text-justify">
                به موجب <strong>رأی وحدت رویه شماره ۸۴۵ مورخ ۱۴۰۳/۰۳/۲۲ هیئت عمومی دیوان عالی کشور</strong>، تایید صحت جریان مزایده توسط دادگاه صادرکننده اجراییه و صدور دستور انتقال سند رسمی موضوع ماده ۱۴۳ قانون اجرای احکام مدنی، مانع از استماع و پذیرش دعوای مستقل «ابطال مزایده و ابطال سند انتقال اجرایی» در دادگاه صلاحیت دار نخواهد بود.
              </p>
              <div className="text-xs text-amber-200 bg-amber-500/10 p-3 rounded-xl border border-amber-500/20 leading-relaxed">
                <strong>اثر حقوقی عملی:</strong> چنانچه تخلفات اساسی نظیر عدم ابلاغ واقعی آگهی، گذشت بیش از ۶ ماه از ارزیابی، غبن فاحش یا تضییع حقوق ثالث رخ داده باشد، حتی اگر دادگاه قبلا سند را به نام خریدار منتقل کرده باشد، مالک قبلی یا شخص ثالث می تواند با طرح دادخواست حقوقی ابطال، معامله را در دادگاه باطل نماید.
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="judicial-criteria" className="bg-[#0D1424] border border-slate-800 rounded-3xl p-6 sm:p-10 space-y-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              <div className="flex items-center gap-2 text-[#E5C158] font-bold text-sm">
                <CheckCircle2 className="w-4 h-4" />
                <h4>انقضای اعتبار ۶ ماهه نظریه کارشناس رسمی</h4>
              </div>
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                بر اساس ماده ۱۹ قانون کانون کارشناسان و رویه متقن قضایی، در صورت گذشت بیش از ۶ ماه از تاریخ ارزیابی و تغییر فاحش قیمت های بازار، فروش مال با بهای منقضی باطل است.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                اگر شخص ثالث با ارائه سند رسمی با تاریخ مقدم یا سند عادی دارای تاریخ معتبر و تصرف قبلی ادعای مالکیت کند، مزایده متوقف و به اعتراض ثالث رسیدگی می شود.
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#070B15] border border-slate-800">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                  اعلام بالاترین پیشنهاد در سامانه، تنظیم صورتمجلس حراج و بازگشت خودکار ۱۰ درصد به حساب سایر شرکت کنندگان ظرف ۲ الی ۴ روز کاری.
                </p>
              </div>
            </div>
