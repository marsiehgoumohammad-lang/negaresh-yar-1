          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <ul className="text-xs sm:text-sm text-slate-400 space-y-1.5 list-disc list-inside leading-relaxed">
                <li>دعاوی مالی که خواسته یا بهای خواسته آن بر اساس مقررات قانونی حاکم، بیش از نصاب قطعی باشد (طبق ماده ۳۳۱ ق.آ.د.م آرای مالی با خواسته بیش از سه میلیون ریال قابل تجدیدنظر است، مگر آنکه طبق قوانین خاص مشمول نصاب دیگری باشند).</li>
            ...
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <ul className="text-xs sm:text-sm text-slate-400 space-y-1.5 list-disc list-inside leading-relaxed">
                <li>جرایم موضوع صلاحیت کیفری دو و کیفری یک بر اساس ماده ۴۲۷ قانون آیین دادرسی کیفری (شامل جرایم دارای مجازات سلب حیات، حبس ابد، قطع عضو یا حبس تعزیری درجه یک تا سه که مرجع تجدیدنظر آنها دیوان عالی کشور است، و سایر جرایم تعزیری قابل تجدیدنظر در دادگاه تجدیدنظر استان).</li>
                <li>احکام محکومیت به پرداخت دیه یا ارش در صورتی که میزان آن بیش از یک دهم دیه کامل باشد.</li>
                <li>احکام ضبط یا مصادره اموال و جرایم مستوجب مجازات های تعزیری تا درجه شش طبق ضوابط ماده ۴۲۷ ق.آ.د.ک (جرایم تعزیری درجه هشت قطعی هستند).</li>
                <li>قرارهای نهایی دادسرا و دادگاه نظیر قرار منع تعقیب یا موقوفی تعقیب در مواردی که اصل جرم یا دعوا قابل تجدیدنظر باشد.</li>
              </ul>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                آرای قاضی شورا یا احکام قضایی صادره در حدود صلاحیت شورای حل اختلاف و دادگاه های صلح، حسب نوع پرونده (حقوقی یا کیفری) ظرف مهلت قانونی در <strong>دادگاه عمومی حقوقی، دادگاه کیفری دو یا دادگاه تجدیدنظر استان</strong> (مطابق قانون حاکم بر شوراها و دادگاه صلح) قابل اعتراض و تجدیدنظرخواهی است.
              </p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                آرای شعب بدوی دیوان عدالت اداری راجع به شکایات از تصمیمات اداری، شهرداری ها، کمیسیون های شبه قضایی (مانند کمیسیون ماده ۱۰۰) و امور استخدامی، ظرف ۲۰ روز برای اشخاص مقیم ایران و دو ماه برای افراد مقیم خارج در <strong>شعب تجدیدنظر دیوان عدالت اداری</strong> قابل اعتراض و تجدیدنظرخواهی است.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed">
            ...
            <div className="p-4 rounded-2xl bg-[#070B15] border border-slate-800 space-y-2 text-xs sm:text-sm text-slate-300">
              ...
              <ul className="space-y-1.5 list-disc list-inside text-slate-400 leading-relaxed">
                <li><strong>روز ابلاغ و روز اقدام</strong> جزء مهلت قانونی محاسبه نمی شوند (طبق ماده ۴۴۵ قانون آیین دادرسی مدنی، روز ابلاغ و روز اقدام به حساب نمی آید). بنابراین مهلت قانونی دقیقاً ۲۰ روز تمام است و نباید آن را به صورت ادعای کلی مهلت ۲۲ روزه در نظر گرفت.</li>
                <li>اگر آخرین روز مهلت با <strong>تعطیلی رسمی یا جمعه</strong> مصادف شود، بر اساس ماده ۴۴۴ قانون آیین دادرسی مدنی، روز پایانی مهلت، نخستین روز پس از تعطیل خواهد بود.</li>
                <li>انقضای مهلت قانونی بدون ثبت دادخواست تجدیدنظر (مگر در موارد اثبات عذر موجه قانونی مطابق ماده ۳۰۶ ق.آ.د.م)، منجر به <strong>«قطعیت رأی»</strong> و صدور قرار رد دادخواست تجدیدنظر می گردد.</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-right text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800 text-slate-300">
                ...
                <tr>
                  ...
                  <td className="p-3">تجدیدنظرخواهی مانع قطعیت رأی است و به جز موارد تصریح شده قانونی (نظیر احکام با دستور اجرای موقت یا فوری) مانع صدور اجراییه می باشد</td>
                  <td className="p-3">اصولاً اجرای مجازات تا صدور رأی قطعی متوقف می ماند، مگر در مواردی که قرارهای تامین کیفری یا ترتیبات قانونی خاص جاری باشد</td>
                </tr>
                <tr>
            ...
            <table className="w-full text-right text-xs sm:text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800 text-slate-300">
                <tr>
                  ...
                  <td className="p-3">رأی بدوی حضوری که در مهلت قانونی اعتراض قرار دارد</td>
                  <td className="p-3">دادگاه تجدیدنظر استان (یا دیوان عالی کشور در موارد خاص)</td>
                  <td className="p-3">۲۰ روز برای مقیمین ایران (۲ ماه مقیمین خارج)</td>
                  <td className="p-3 text-emerald-400 font-bold">مانع قطعیت و اصولاً مانع اجرا</td>
                  <td className="p-3">ماده ۳۳۰ ق.آ.د.م</td>
                </tr>
                <tr>
                  <td className="p-3 font-bold text-red-400">رأی قطعی</td>
                  <td className="p-3">رأیی که به لحاظ قانونی غیرقابل تجدیدنظر بوده یا مهلت قانونی آن سپری شده</td>
                  <td className="p-3">واحد اجرای احکام مدنی / کیفری</td>
                  <td className="p-3">منقضی شده یا از ابتدا قطعی</td>
                ...
                <tr>
                  ...
                  <td className="p-3">اعتراض به حکم غیابی توسط محکوم علیه غایب</td>
                  <td className="p-3">همان دادگاه صادرکننده رأی غیابی</td>
                  <td className="p-3">۲۰ روز از تاریخ ابلاغ واقعی یا اثبات عدم اطلاع در ابلاغ قانونی</td>
                  <td className="p-3 text-emerald-400 font-bold">توقف یا مانع اجرای حکم طبق ماده ۳۰۶ ق.آ.د.م</td>
                  <td className="p-3">ماده ۳۰۵ ق.آ.د.م</td>
                </tr>
                <tr>
                  <td className="p-3 font-bold text-purple-400">تجدیدنظرخواهی</td>
                  <td className="p-3">طریق عادی اعتراض به احکام و قرارهای قابل تجدیدنظر دادگاه بدوی</td>
                  <td className="p-3">دادگاه تجدیدنظر استان (یا دیوان عالی کشور)</td>
                  <td className="p-3">۲۰ روز برای مقیمین ایران (۲ ماه خارج)</td>
                  <td className="p-3 text-emerald-400 font-bold">تعلیق اجرای دادنامه (به جز استثنائات قانونی)</td>
                  <td className="p-3">ماده ۳۳۴ مدنی / ۴۲۷ کیفری</td>
                </tr>
                <tr>
                  <td className="p-3 font-bold text-amber-400">اعاده دادرسی</td>
                  <td className="p-3">طریق فوق العاده شکایت از احکام قطعی در جهات حصری ماده ۴۲۶ ق.آ.د.م یا ماده ۴۷۴ ق.آ.د.ک</td>
                  <td className="p-3">دادگاه صادرکننده حکم قطعی (مدنی) یا دیوان عالی کشور (کیفری)</td>
                  <td className="p-3">۲۰ روز (برای مقیمین ایران) از تاریخ ابلاغ رأی یا کشف جهت اعاده (مانند کشف سند مکتوم یا اثبات جعل)</td>
                  <td className="p-3">صرف دادخواست مانع اجرا نیست؛ منوط به صدور قرار قبولی اعاده دادرسی یا دستور توقف طبق قانون است</td>
                  <td className="p-3">مواد ۴۲۶ و ۴۲۷ ق.آ.د.م / ۴۷۴ ق.آ.د.ک</td>
                </tr>
              </tbody>
            </table>
          </div>
