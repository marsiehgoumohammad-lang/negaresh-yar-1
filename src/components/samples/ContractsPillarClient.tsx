  ...
  return (
    <div className="space-y-16 sm:space-y-24 py-6 sm:py-10 selection:bg-[#E5C158] selection:text-[#070B15]">
        ...
        <Container className="relative z-10 text-center">
          ...
          <div className="mb-8">
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-[#E5C158]/10 hover:bg-[#E5C158]/20 border border-[#E5C158]/30 text-[#E5C158] text-xs sm:text-sm font-bold transition-all shadow-md"
            >
              <Sparkles className="w-4 h-4 text-[#E5C158]" />
              <span>نیاز به تنظیم اختصاصی یا بازبینی قرارداد دارید؟ مشاهده خدمت تخصصی نگارش یار</span>
      ...
      <Container className="space-y-16 sm:space-y-24">
        ...
        {/* ---------------------------------------------------- */}
        <section id="contracts-grid" className="scroll-mt-24 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                ...
                desc: 'برای هر روز تاخیر در انجام تعهد، خسارت روزانه مقطوع قید نمایید و تصریح کنید که دریافت خسارت بدل از انجام اصل تعهد نخواهد بود.',
              },
              {
                num: '۰۵',
                title: 'تعیین شرط داوری تخصصی مرضی الطرفین',
                desc: 'با تعیین داور حقوقی معتمد و بی طرف با قبولی کتبی، حل اختلاف به شیوه ای تخصصی تر دنبال شده و رای داور از طریق اجرای احکام دادگستری پیگیری می شود.',
              },
              {
                num: '۰۶',
              ...
              {
                num: '۰۹',
                title: 'امضا در حضور حداقل دو شاهد معتمد',
                desc: 'به ویژه در قراردادهای اجاره، امضای دو شاهد مورد اعتماد طرفین برای استفاده از مزایای قانونی تخلیه فوری در شورا الزامی است.',
              },
              {
                num: '۱۰',
        ...
        {/* ---------------------------------------------------- */}
        {/* 5.5 3-TIER ACTION MODULE */}
        {/* ---------------------------------------------------- */}
        <section className="rounded-3xl bg-slate-900/60 border border-slate-800 p-6 sm:p-10 space-y-6">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#E5C158]/10 border border-[#E5C158]/30 text-[#E5C158] text-xs font-bold">
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              متناسب با ارزش مالی معامله و پیچیدگی رابطه طرفین، مناسب ترین سطح اقدام را انتخاب نمایید:
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            {/* Tier 1 */}
            <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-bold text-white">بانک ۲۸ الگوی خام قرارداد</h3>
                <p className="text-xs text-slate-300 leading-relaxed">
                  مشاهده و کپی رایگان متون ۲۸ قرارداد استاندارد ملکی، تجاری، خودرو، استخدام و صلح نامه برای آشنایی با ساختار حقوقی.
                </p>
              </div>
              <button
                onClick={() => {
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-semibold text-center transition-colors block cursor-pointer"
              >
                مشاهده الگوهای همین صفحه
              </button>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900 border-2 border-[#E5C158] flex flex-col justify-between space-y-4 relative shadow-xl shadow-[#E5C158]/5">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-bold text-white">تنظیم و بازبینی اختصاصی</h3>
                <p className="text-xs text-slate-300 leading-relaxed">
                  تنظیم سفارشی قرارداد متناسب با اسناد، تعیین وجه التزام روزانه، شروط بازدارنده و تضامین چک صیادی توسط کارشناسان حقوقی.
                </p>
              </div>
              <Link
                href="/services/contract-drafting"
            ...
            <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-bold text-white">معرفی وکیل پایه یک منصف</h3>
                <p className="text-xs text-slate-300 leading-relaxed">
                  مناسب برای قراردادهای کلان میلیاردی، مشارکت های پیچیده ساختمانی یا حضور وکیل در جلسات مذاکره و انعقاد معامله.
                </p>
              </div>
              <Link
        ...
        <section className="rounded-3xl bg-gradient-to-r from-[#0C1222] via-[#10182E] to-[#0C1222] border border-[#E5C158]/30 p-8 sm:p-12 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                <span>مشاهده خدمات تخصصی تنظیم قرارداد</span>
              ...
              >
                <Sparkles className="w-4 h-4 text-[#E5C158]" />
                <span>ثبت سفارش آنلاین تنظیم قرارداد</span>
              </Link>
              ...
              {messengerLinks.length > 0 && (
                <a
                  ...
                  className="px-6 py-3.5 rounded-2xl bg-slate-900/90 hover:bg-slate-800 text-slate-300 text-sm font-medium border border-slate-800 transition-all flex items-center gap-2"
                >
                  <MessageCircle className="w-4 h-4 text-emerald-400" />
                  <span>مشاوره در پیام رسان</span>
                </a>
              )}
            </div>
