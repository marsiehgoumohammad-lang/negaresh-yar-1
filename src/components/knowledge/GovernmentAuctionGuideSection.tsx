    ...
    switch (selectedRole) {
      ...
      case 'auction-objector':
        return {
          ...
          criticalWarning:
            'طبق ماده ۱۴۲ مهلت شکایت یک هفته است؛ دادگاه تا رسیدگی به شکایت دستور انتقال سند نمی‌دهد، اما پس از صدور سند رسمی، اثبات بطلان فرآیندی بسیار دشوار خواهد بود.',
          serviceLink: {
