...
export function GovernmentAuctionGuideSection() {
  ...
  const getRoleRecommendation = (): DecisionResult => {
    switch (selectedRole) {
      ...
      case 'auction-winner':
        return {
          title: 'اقدامات حیاتی برنده مزایده: تسویه باقیمانده ثمن و انتقال سند',
          badge: 'برنده مزایده و حفظ سپرده',
          badgeColor: 'bg-blue-500/10 text-blue-400 border-blue-500/30',
          statusSummary:
            'برنده مزایده کسی است که بالاترین قیمت را پیشنهاد داده است. طبق قانون، وی موظف است باقیمانده مبلغ را دقیقاً ظرف مهلت اعلامی در آگهی (حداکثر تا یک ماه) واریز نماید.',
          legalArticle: 'مواد ۱۲۹ و ۱۴۳ قانون اجرای احکام مدنی',
          deadlineNotice: 'مهلت مقرر در آگهی (حداکثر یک ماه از تاریخ جلسه مزایده)',
          immediateAction:
            'بلافاصله فیش واریزی باقیمانده ثمن را به همراه لایحه اعلام تسویه به شعبه اجرای احکام تسلیم و صدور دستور انتقال سند رسمی پس از احراز صحت مزایده را از دادگاه پیگیری نمایید.',
          recommendedPath:
            'واریز باقیمانده ثمن به حساب سپرده اجرای احکام، احراز صحت مزایده توسط دادگاه (ماده ۱۴۳)، صدور دستور انتقال و امضای سند رسمی توسط دادورز در صورت امتناع مالک.',
          requiredDocuments: [
            'اصل فیش واریز ۱۰ درصد اولیه و مابقی ثمن معامله',
            'برگه پرینت اعلام برنده سامانه ستاد ایران',
            'لایحه اعلام تسویه کامل ثمن و تقاضای صدور دستور انتقال سند رسمی',
            'مشخصات دقیق دفترخانه اسناد رسمی جهت تنظیم سند',
          ],
          criticalWarning:
            'اگر ظرف مهلت تعیین شده در آگهی (حداکثر یک ماه) بقیه ثمن معامله را تودیع نکنید، سپرده شما پس از کسر هزینه های مزایده به نفع دولت ضبط شده و مزایده تجدید خواهد شد (ماده ۱۲۹).',
          serviceLink: {
      ...
      case 'refund-seeker':
        return {
          title: 'نحوه استرداد سریع تضمین و سپرده مزایده برای برنده نشدگان',
          badge: 'استرداد سپرده ۱۰ درصدی',
          badgeColor: 'bg-purple-500/10 text-purple-400 border-purple-500/30',
          statusSummary:
            'مبالغ و تضمین های واریزی شرکت کنندگانی که پیشنهاد آن ها برنده نشده است، طبق ماده ۱۲۸ ق.ا.ا.م مسترد و آزاد می گردد و مشمول هیچ گونه کسری یا جریمه ای نخواهد بود.',
          legalArticle: 'ماده ۱۲۸ قانون اجرای احکام مدنی',
          deadlineNotice: 'پس از پایان جلسه مزایده و تعیین تکلیف برنده',
          immediateAction:
            'در سامانه ستاد از بخش کارتابل مالی، وضعیت عودت وجه تضمین را بررسی نمایید؛ در صورت تاخیر در بازگشت وجه پس از اتمام فرآیند حراج، از طریق شعبه اجرای احکام پیگیری فرمایید.',
          recommendedPath:
            'بررسی شماره شبای بانکی در سامانه ستاد و ثنا یا ارائه فیش واریزی به واحد حسابداری اجرای احکام جهت استرداد سیستمی وجه.',
          requiredDocuments: [
            'رسید پرداخت الکترونیک تضمین با شماره پیگیری بانکی',
            'تصویر صفحه اعلام نتایج سامانه ستاد مبنی بر عدم برنده شدن',
            'شماره شبا بانکی به نام دقیق شرکت کننده',
            'درخواست کتبی استرداد سپرده خطاب به رئیس اجرای احکام در صورت نیاز',
          ],
          criticalWarning:
      ...
      case 'auction-objector':
        return {
          title: 'نحوه شکایت و اعتراض به مزایده و تقاضای ابطال آن',
          badge: 'اعتراض و ابطال مزایده',
          badgeColor: 'bg-rose-500/10 text-rose-400 border-rose-500/30',
          statusSummary:
            'اشخاص ذی نفع در صورت تخلف دادورز از مقررات مزایده، نقض مهلت ها یا ارزیابی غیرواقعی می توانند شکایت کنند و با استناد به جهات قانونی بطلان مزایده موضوع ماده ۱۳۶، ابطال مزایده را از دادگاه بخواهند.',
          legalArticle: 'مواد ۱۳۶، ۱۴۲، ۱۴۶ و ۱۴۷ قانون اجرای احکام مدنی',
          deadlineNotice: 'مهلت ۱ هفته از تاریخ وقوع بر اساس ماده ۱۴۲',
          immediateAction:
            'پیش از تایید صحت مزایده توسط دادگاه و صدور دستور انتقال سند رسمی، لایحه شکایت مستند به مواد قانونی را تقدیم دادگاه نمایید تا از صدور دستور انتقال سند خودداری شود.',
          recommendedPath:
            'اگر ادعای حق یا مالکیت از سوی ثالث است: ثبت دعوای اعتراض ثالث اجرایی (مواد ۱۴۶ و ۱۴۷). اگر تشریفات مزایده نقض شده است: ثبت شکایت از عملیات اجرایی (ماده ۱۴۲).',
          requiredDocuments: [
            'گزارش آگهی مزایده و مستندات نشان دهنده نقض تشریفات مقرر در ماده ۱۳۶',
            'مستندات مالکیت رسمی یا دلایل معتبر شخص ثالث در دعوای اعتراض ثالث',
            'نظریه کارشناسی اولیه و مستندات مربوط به تغییر محسوس ارزش مال یا فاصله زمانی تا برگزاری مزایده',
            'لایحه حقوقی مستدل خطاب به دادگاه صادرکننده اجرائیه',
          ],
          criticalWarning:
            'طبق ماده ۱۴۲ مهلت شکایت یک هفته است؛ دادگاه تا رسیدگی به شکایت دستور انتقال سند نمی دهد. همچنین به موجب رأی وحدت رویه شماره ۸۴۵ دیوان عالی کشور، حتی در صورت تایید صحت مزایده و صدور سند رسمی، اقامه دعوای مستقل ابطال مزایده و سند انتقال در دادگاه صلاحیت دار مسموع است.',
          serviceLink: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            },
            {
              ...
              title: 'تامین وجه نقد باقیمانده ثمن معامله ظرف مهلت مقرر در آگهی (حداکثر یک ماه)',
              desc: 'موعد پرداخت در آگهی تعیین می شود و سقف آن یک ماه است؛ عدم واریز در مهلت موجب ضبط سپرده پس از کسر هزینه ها طبق ماده ۱۲۹ ق.ا.ا.م می شود.',
            },
            {
              id: 'item7',
      ...
      <div className="p-6 md:p-8 rounded-3xl bg-gradient-to-br from-[#0C1222] to-[#121A2E] border border-slate-800 shadow-xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-blue-500/30 space-y-1">
              ...
              <span className="text-[10px] text-slate-400 block">طبق مهلت مقرر در آگهی (حداکثر ۱ ماه)</span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-700 space-y-1">
              ...
              <span className="text-[10px] text-slate-400 block">تخمینی طبق شرایط آگهی</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-900/40 border border-slate-800 text-[11px] text-slate-400 leading-relaxed flex items-start gap-2.5">
          ...
          <span>
            ...
            پرداخت حق الاجرا (نیم عشر اجرایی) قانوناً بر عهده محکوم علیه (بدهکار) است و از حاصل فروش مال وصول می شود؛ بنابراین خریدار مزایده ملزم به پرداخت حق الاجرا مازاد بر ثمن پیشنهادی نیست و صرفاً هزینه های رسمی تنظیم سند و نقل و انتقال را بر اساس قوانین و شرایط آگهی می پردازد.
          </span>
        </div>
      </div>
    </div>
