    ...
    switch (selectedRole) {
      ...
      case 'refund-seeker':
        return {
          ...
          immediateAction:
            'در سامانه ستاد از بخش کارتابل مالی، وضعیت عودت وجه تضمین را بررسی نمایید؛ در صورت عدم واریز خودکار ظرف ۷۲ ساعت، از طریق شعبه اجرای احکام پیگیری فرمایید.',
          recommendedPath:
      ...
      case 'auction-objector':
        return {
          ...
          statusSummary:
            'اشخاص ذی نفع در صورت تخلف دادورز از مقررات مزایده، نقض مهلت ها یا ارزیابی غیرواقعی می توانند شکایت کنند و در موارد ۵ گانه ماده ۱۳۶، ابطال مزایده را از دادگاه بخواهند.',
          legalArticle: 'مواد ۱۳۶، ۱۴۲، ۱۴۶ و ۱۴۷ قانون اجرای احکام مدنی',
          deadlineNotice: 'مهلت ۱ هفته از تاریخ وقوع یا اطلاع بر اساس ماده ۱۴۲',
          immediateAction:
          ...
          requiredDocuments: [
            ...
            'نظریه کارشناسی اولیه و مستندات سپری شدن مهلت ۶ ماهه ارزیابی (ماده ۱۹ کانون کارشناسان)',
