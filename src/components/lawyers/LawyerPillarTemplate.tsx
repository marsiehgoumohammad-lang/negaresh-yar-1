...
import { LawyerReferralGuideSection } from './LawyerReferralGuideSection';
  ...
  const jsonLdGraph = {
    ...
    '@graph': [
      ...
      },
      {
        '@type': 'LegalService',
        '@id': `${pageUrl}#service`,
        name: 'خدمات تنظیم اوراق قضایی و راهنمای معرفی وکیل دادگستری',
        description:
          'سامانه تخصصی تنظیم لوایح دفاعیه و دادخواست توسط نگارش یار و راهنمای پیوند موکلان با وکلای پایه یک دادگستری متعهد و منصف جهت اعلام وکالت مستقیم در پرونده های قضایی.',
        provider: {
          '@id': `${baseUrl}#organization`,
        },
        areaServed: {
        ...
        serviceType: 'تنظیم لایحه، دادخواست و ارجاع به وکیل دادگستری',
        url: pageUrl,
      },
      {
        '@type': 'FAQPage',
    ...
    <div className="min-h-screen bg-[#070B15] text-slate-100 selection:bg-[#E5C158]/30 selection:text-white" dir="rtl">
      ...
      <main className="py-12 sm:py-16 space-y-16 sm:space-y-24">
        <Container className="space-y-16 sm:space-y-24">
          ...
          <section className="relative bg-gradient-to-b from-[#0D1424] via-[#070B15] to-[#0D1424] p-8 sm:p-12 rounded-3xl border border-slate-800">
            <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
              ...
              <p className="text-slate-300 text-sm sm:text-base">
                برای انتخاب وکیل متناسب با شرایط حقوقی و توان مالی خود، این ۴ مرحله کاربردی را طی کنید:
              </p>
            </div>
          ...
          {/* ---------------------------------------------------- */}
                    {/* ---------------------------------------------------- */}
          {/* COMPREHENSIVE LAWYER REFERRAL & LEGAL FEES GUIDE */}
          {/* ---------------------------------------------------- */}
          <LawyerReferralGuideSection />
