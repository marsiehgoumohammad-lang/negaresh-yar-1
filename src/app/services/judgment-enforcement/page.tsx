...
import { JudgmentEnforcementGuideSection } from '@/components/services/JudgmentEnforcementGuideSection';
import {
  judgmentEnforcementData,
  judgmentEnforcementMetadata,
} from '@/data/services/judgment-enforcement';

export const metadata = judgmentEnforcementMetadata;

export default function JudgmentEnforcementPage() {
  const data = {
    ...judgmentEnforcementData,
    customGuideContent: <JudgmentEnforcementGuideSection />,
  };
  ...
  return (
    <>
      <Script
        id="judgment-enforcement-schema-graph"
