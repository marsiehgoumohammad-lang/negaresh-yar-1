...
import {
  falseWitnessInquiryData,
  falseWitnessInquiryMetadata,
} from '@/data/services/false-witness-inquiry';

export const metadata = falseWitnessInquiryMetadata;

export default function FalseWitnessInquiryPage() {
  const data = falseWitnessInquiryData;
