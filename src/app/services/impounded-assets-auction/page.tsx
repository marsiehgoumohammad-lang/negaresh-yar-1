...
import {
  impoundedAssetsAuctionData,
  impoundedAssetsAuctionMetadata,
} from '@/data/services/impounded-assets-auction';

export const metadata = impoundedAssetsAuctionMetadata;

export default function ImpoundedAssetsAuctionPage() {
  const data = impoundedAssetsAuctionData;
