...
import { AbsentJudgmentObjectionGuideSection } from '@/components/services/AbsentJudgmentObjectionGuideSection';
import {
  objectionAbsentJudgmentData,
  objectionAbsentJudgmentMetadata,
} from '@/data/services/objection-absent-judgment';

export const metadata = objectionAbsentJudgmentMetadata;

export default function ObjectionAbsentJudgmentPage() {
  const data = {
    ...objectionAbsentJudgmentData,
    customGuideContent: <AbsentJudgmentObjectionGuideSection />,
  };
  ...
  return (
    <>
      <Script
        id="objection-absent-judgment-schema-graph"
