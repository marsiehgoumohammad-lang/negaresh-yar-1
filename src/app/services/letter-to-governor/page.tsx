...
import { GovernorLetterGuideSection } from '@/components/services/GovernorLetterGuideSection';
import {
  letterToGovernorData,
  letterToGovernorMetadata,
} from '@/data/services/letter-to-governor';

export const metadata = letterToGovernorMetadata;

export default function LetterToGovernorPage() {
  const data = {
    ...letterToGovernorData,
    customGuideContent: <GovernorLetterGuideSection />,
  };
