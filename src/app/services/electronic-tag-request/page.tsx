...
import { ElectronicTagGuideSection } from '@/components/services/ElectronicTagGuideSection';
import {
  electronicTagRequestData,
  electronicTagRequestMetadata,
} from '@/data/services/electronic-tag-request';

export const metadata = electronicTagRequestMetadata;

export default function ElectronicTagRequestPage() {
  const data = {
    ...electronicTagRequestData,
    customGuideContent: <ElectronicTagGuideSection />,
  };
