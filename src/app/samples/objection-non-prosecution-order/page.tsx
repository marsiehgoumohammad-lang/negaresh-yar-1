...
} from '@/data/samples/objection-non-prosecution-order';

export const metadata = sampleObjectionNonProsecutionOrderMetadata;

export default function SampleObjectionNonProsecutionOrderPage() {
  const data = sampleObjectionNonProsecutionOrderData;
