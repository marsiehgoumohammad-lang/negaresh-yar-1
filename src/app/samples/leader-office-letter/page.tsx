...
} from '@/data/samples/leader-office-letter';

export const metadata = sampleLeaderOfficeLetterMetadata;

export default function LeaderOfficeLetterSamplePage() {
  const data = sampleLeaderOfficeLetterData;
