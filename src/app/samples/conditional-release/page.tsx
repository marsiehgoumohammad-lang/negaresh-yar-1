...
} from '@/data/samples/conditional-release';

export const metadata = sampleConditionalReleaseMetadata;

export default function SampleConditionalReleasePage() {
  const data = sampleConditionalReleaseData;
