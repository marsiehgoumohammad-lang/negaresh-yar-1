...
} from '@/data/samples/letter-to-tax-office';

export const metadata = sampleLetterToTaxOfficeMetadata;

export default function SampleLetterToTaxOfficePage() {
  const data = sampleLetterToTaxOfficeData;
