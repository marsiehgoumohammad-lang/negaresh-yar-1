...
} from '@/data/samples/letter-to-governor';

export const metadata = sampleLetterToGovernorMetadata;

export default function SampleLetterToGovernorPage() {
  const data = sampleLetterToGovernorData;
