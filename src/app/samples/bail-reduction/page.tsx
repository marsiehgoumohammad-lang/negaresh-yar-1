...
} from '@/data/samples/bail-reduction';

export const metadata = sampleBailReductionMetadata;

export default function BailReductionSamplePage() {
  const data = sampleBailReductionData;
