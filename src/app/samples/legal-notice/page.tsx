...
} from '@/data/samples/legal-notice';

export const metadata = sampleLegalNoticeMetadata;

export default function LegalNoticeSamplePage() {
  const data = sampleLegalNoticeData;
