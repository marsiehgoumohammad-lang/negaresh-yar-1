...
} from '@/data/samples/president-letter';

export const metadata = samplePresidentLetterMetadata;

export default function PresidentLetterSamplePage() {
  const data = samplePresidentLetterData;
