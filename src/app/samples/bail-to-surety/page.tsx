...
} from '@/data/samples/bail-to-surety';

export const metadata = sampleBailToSuretyMetadata;

export default function SampleBailToSuretyPage() {
  const data = sampleBailToSuretyData;
