...
} from '@/data/samples/legal-brief';

export const metadata = sampleLegalBriefMetadata;

export default function LegalBriefSamplePage() {
  const data = sampleLegalBriefData;
