...
--   * Sensitive tables (customers, invoices, invoice_items, settings)
...
-- NOTE: customers, invoices, invoice_items and settings intentionally have
-- no anon/authenticated policies. Access them from your server using the
